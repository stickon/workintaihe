...
//        [self.tableView registerClass:sectionMaker.section.cell forCellReuseIdentifier:sectionMaker.section.identifier];
        [self.tableView registerNib:[UINib nibWithNibName:NSStringFromClass(sectionMaker.section.cell) bundle:nil] forCellReuseIdentifier:sectionMaker.section.identifier];
    }
