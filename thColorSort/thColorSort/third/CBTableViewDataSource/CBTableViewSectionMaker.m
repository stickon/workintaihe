...
- (CBTableViewSectionMaker *(^)(void (^)(NSUInteger, NSUInteger, NSInteger)))cellDataChanged {
    return ^CBTableViewSectionMaker *(CellDataChangedBlock cellDataChanged){
        self.section.cellDataChanged = cellDataChanged;
        return self;
    };
}
